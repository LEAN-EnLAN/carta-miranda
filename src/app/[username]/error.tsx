...
export default function Error({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <h1 className="font-serif text-3xl text-[color:var(--ink)]">No pudimos cargar el perfil</h1>
      <p className="mt-4 max-w-md text-sm leading-6 text-[color:var(--ink-muted)]">Algo falló al buscar las cartas. Probá de nuevo o volvé al inicio.</p>
